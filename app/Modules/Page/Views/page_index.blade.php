...
<div class="page-header">
	<h1>Pages <span class="pull-right"><a href="{{ route('admin.pages.create') }}" class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Create</a></span>{{$junked ? ' &raquo; Trashed' :''}}</h1>
</div>
@if($deleted)
				...
				<tr class="{{ $row->deleted_at ? ' bg-warning' :'' }}">
					...
					<td>
						<div class="btn-group">
							...
							<a data-rel="tooltip" data-original-title="Permanent Delete!" href="{{route('admin.pages.delete', $row->id)}}" class="btn btn-xs btn-danger tooltip-default">
