...
<html lang="en">
  <head>
    ...
    <!-- ace styles -->
    {{-- <link rel="stylesheet" href="{{ asset('themes/ace-admin/css/ace.min.css') }}" /> --}}
    <?php /* LARAVEL Mix see webpack.mix.js for recompile the files */ ?>
    <link rel="stylesheet" href="{{ mix('themes/ace-admin/css/d3all.css') }}">
    <!--[if lte IE 9]><link rel="stylesheet" href="{{ asset('themes/ace-admin/css/ace-part2.min.css') }}" /><![endif]-->
    <link rel="stylesheet" href="{{ asset('themes/ace-admin/css/ace-rtl.min.css') }}" />
    <!--[if lte IE 9]><link rel="stylesheet" href="{{ asset('themes/ace-admin/css/ace-ie.min.css') }}" /><![endif]-->
    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script src="{{ asset('themes/ace-admin/js/html5shiv.min.js') }}"></script>
    <script src="{{ asset('themes/ace-admin/js/respond.min.js') }}"></script>
    <![endif]-->
  </head>
  <body class="login-layout">
    ...
    @yield('scripts')
    <!-- basic scripts -->
    <!--[if !IE]> --><script src="{{ asset('themes/ace-admin/js/jquery.2.1.1.min.js') }}"></script><!-- <![endif]-->
    <!--[if IE]><script src="{{ asset('themes/ace-admin/js/jquery.1.11.1.min.js') }}"></script><![endif]-->
    <!--[if !IE]> -->
    <script type="text/javascript">window.jQuery || document.write("<script src='{{ asset('themes/ace-admin/js/jquery.min.js') }}'>"+"<"+"/script>");</script>
    <!-- <![endif]-->
    <!--[if IE]><script type="text/javascript">window.jQuery || document.write("<script src='{{ asset('themes/ace-admin/js/jquery1x.min.js') }}'>"+"<"+"/script>");</script><![endif]-->
