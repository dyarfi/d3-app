...
<div class="row">
	<div class="col-xs-12">		
		...
		{!! Form::open(['route'=>'admin.tasks.change']) !!}		
			...
			<tbody>
				...
				<tr class="{{ $row->deleted_at ? ' bg-warning' :'' }}">
					...
					<td>
						<div class="btn-group">
							@if (!$row->deleted_at)
							<a data-rel="tooltip" data-original-title="View" title="" href="{{ route('admin.tasks.show', $row->id) }}" class="btn btn-xs btn-success tooltip-default">
								<i class="ace-icon fa fa-check bigger-120"></i>
							</a>
							<a data-rel="tooltip" data-original-title="Edit"  href="{{ route('admin.tasks.edit', $row->id) }}" class="btn btn-xs btn-info tooltip-default">
								<i class="ace-icon fa fa-pencil bigger-120"></i>
							</a>
							<a data-rel="tooltip" data-original-title="Trashed"  href="{{ route('admin.tasks.trash', $row->id) }}" class="btn btn-xs btn-danger tooltip-default">
							...
							@else 
							<a data-rel="tooltip" data-original-title="Restore!" href="{{route('admin.tasks.restored', $row->id)}}" class="btn btn-xs btn-primary tooltip-default">
								<i class="ace-icon fa fa-save bigger-120"></i>
							</a>
							<a data-rel="tooltip" data-original-title="Permanent Delete!" href="{{route('admin.tasks.delete', $row->id)}}" class="btn btn-xs btn-danger tooltip-default">
