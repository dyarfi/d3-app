...
<div class="page-header">
	<h1><a href="{{ route('admin.blogs.index') }}">Blogs</a>
		<span class="pull-right"><a href="{{ route('admin.blogs.create') }}" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span> Create</a></span>{{$junked ? ' &raquo; Trashed' :''}}
		<div class="pull-right">
		   <div class="col-md-6 dropdown">
			   ...
			   <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
				   <li><a href="{{route('admin.blogs.export','rel=xls')}}" class=""><span class="fa fa-file-excel-o"></span> XLS</a></li>
				   <li><a href="{{route('admin.blogs.export','rel=csv')}}" class=""><span class="fa fa-file-text-o"></span> CSV</a></li>
			   </ul>
		   </div>
	   </div>
	</h1>
...
<div class="clearfix">
	<div class="pull-right">
		<a href="{{route('admin.blogs.index','path=trashed')}}" title="Restored Deleted" class="btn btn-link btn-xs"><span class="fa fa-trash"></span> {{ $deleted }} Deleted</a>
	</div>
</div>
@endif
{!! Form::open(['route'=>'admin.blogs.change']) !!}
