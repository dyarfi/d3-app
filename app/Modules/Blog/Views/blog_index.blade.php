...
<div class="page-header">
	<h1>Blogs <span class="pull-right"><a href="{{ route('admin.blogs.create') }}" class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Create</a></span>{{$junked ? ' &raquo; Trashed' :''}}</h1>
</div>
@if($deleted)
