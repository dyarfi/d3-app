...
return
    ...
    [
         ...
         */
        'siteId' => 'ga:42489917',//env('138882753'),
         ...
         */
        'clientId' => 'ganalytic@dentsu-digital-division.iam.gserviceaccount.com', //env('ganalytic@dentsu-digital-division.iam.gserviceaccount.com'),
         ...
         */
        'serviceEmail' => 'google-analytics-api@dentsu-digital-division.iam.gserviceaccount.com',//env('google-analytics-api@dentsu-digital-division.iam.gserviceaccount.com'),

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('laravel-analytics/DefrianYarfi-5e8f69b6dda6.p12'),
