...
return [
	...
	*/
	...
	"dimensions" => [
		"min_width"		=> "The :attribute must be min width :value . ",
		"min_height" 	=> "The :attribute must be min height :value . ",
		"max_width"		=> "The :attribute must be max width :value . ",
		"max_height" 	=> "The :attribute must be max height :value . ",
		"width"			=> "The :attribute must be width :value . ",
		"height" 		=> "The :attribute must be height :value . ",
		"ratio" 		=> "The :attribute must be ratio :value . ",
	],
